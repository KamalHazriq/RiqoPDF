...
export const CATEGORIES: ToolCategory[] = [
  ...
  },
  {
    name: "Convert PDF",
    tools: [
      { slug: "pdf-to-word", name: "PDF to Word", description: "Convert PDF to editable DOCX.", icon: "FileText", status: "coming-soon" },
      { slug: "pdf-to-excel", name: "PDF to Excel", description: "Convert PDF to XLSX.", icon: "Sheet", status: "coming-soon" },
      { slug: "pdf-to-powerpoint", name: "PDF to PowerPoint", description: "Convert PDF to PPTX.", icon: "Presentation", status: "coming-soon" },
      { slug: "word-to-pdf", name: "Word to PDF", description: "Convert DOCX to PDF.", icon: "FileText", status: "coming-soon" },
      { slug: "excel-to-pdf", name: "Excel to PDF", description: "Convert XLSX to PDF.", icon: "Sheet", status: "coming-soon" },
      { slug: "powerpoint-to-pdf", name: "PowerPoint to PDF", description: "Convert PPTX to PDF.", icon: "Presentation", status: "coming-soon" },
      ...
      { slug: "pdf-to-html", name: "PDF to HTML", description: "Convert PDF into an HTML page.", icon: "Code2", status: "coming-soon" },
      { slug: "pdf-to-markdown", name: "PDF to Markdown", description: "Convert PDF into Markdown.", icon: "FileCode", status: "coming-soon" },
    ],
  },
  {
    name: "Edit PDF",
